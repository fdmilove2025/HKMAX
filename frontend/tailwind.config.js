  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(to right, rgba(6, 182, 212, 0.1), rgba(124, 58, 237, 0.1))',
      ...
      boxShadow: {
        'neon-glow': '0 0 5px theme("colors.cyan.400"), 0 0 20px theme("colors.cyan.600")',
        'neon-purple': '0 0 5px theme("colors.purple.400"), 0 0 20px theme("colors.purple.600")',
        'glass': '0 4px 30px rgba(0, 0, 0, 0.1)',
        'dark-glow': '0 4px 20px rgba(6, 182, 212, 0.3)',
      },
      backdropBlur: {
        'xs': '2px',
      },
